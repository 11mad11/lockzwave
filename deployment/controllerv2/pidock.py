...
scripts = {
    'extract': 'deployment/controllerv2/support/1-extract.sh',
    'build': 'deployment/controllerv2/support/2-build.sh',
    'compose': 'deployment/controllerv2/support/3-compose.sh',
    'flash': 'deployment/controllerv2/support/4-flash.sh',
}
